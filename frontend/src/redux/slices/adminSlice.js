...
export const uptateUser = createAsyncThunk(
  "admin/updateUser",
...
const adminSlise = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(uptateUser.pending, (state) => {
        (state.loading = true), (state.error = null);
      })
      .addCase(uptateUser.fulfilled, (state, action) => {
      ...
      .addCase(uptateUser.rejected, (state, action) => {
        (state.loading = false), (state.error = action.error.message);
      })
